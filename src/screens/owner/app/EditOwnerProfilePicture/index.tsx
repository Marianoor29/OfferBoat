...
const EditOwnerProfilePicture = ({ navigation , route}: any) => {
  ...
  const updateProfilePicture = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${baseURL}/uploadProfilePicture`, formData, {
        headers: {
...
export default EditOwnerProfilePicture;